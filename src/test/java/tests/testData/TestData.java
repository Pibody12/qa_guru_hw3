...
public class TestData {
    ...
    public static String userSubject = "Accounting";
    public static String userHobbies1 = "Sports";
    public static String userHobbies2 = "Reading";
    public static String userHobbies3 = "Music";
